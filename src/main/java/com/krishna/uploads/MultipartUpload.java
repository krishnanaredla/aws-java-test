...
public class MultipartUpload {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Logger LOGGER = Logger.getLogger(MultipartUpload.class.getName() );
        Regions clientRegion = Regions.US_WEST_1;
        String bucketName = "tmp";
        String keyName = "multiupload.tar";
        ...
        LOGGER.log(Level.FINE,"Starting the program");
        ...
        try {
            ...
            for (int i = 1; filePosition < contentLength; i++) {
                ...
                LOGGER.log(Level.FINE,"Started uploading");
                System.out.println("Started uploading size "+String.valueOf(filePosition));
            ...
            LOGGER.log(Level.FINE,"Completed uploading");
            System.out.println(java.time.LocalTime.now());
